    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors">
      ...
      {currentView === 'home' && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
          ...
          <div className="max-w-2xl mx-auto py-8 sm:py-12 px-6 sm:px-8 mb-8 bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-slate-800 dark:to-gray-900 rounded-2xl shadow-xl border border-red-100 dark:border-gray-700">
              ...
              return (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div
                    ...
                    className="lg:row-span-2 bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-slate-800 dark:to-gray-900 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden cursor-pointer group border border-red-100 dark:border-gray-700"
                  >
                  ...
                  {gridArticles.map(article => (
                    <div
                      ...
                      className="bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-slate-800 dark:to-gray-900 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden cursor-pointer group border border-red-100 dark:border-gray-700"
                    >
